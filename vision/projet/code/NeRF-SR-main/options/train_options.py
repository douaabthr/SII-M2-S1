...
# je doircomprendre chaque argument
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        #  tout d'abord elle instancier un objet parser de la classe base options 
        # pour quoi tout ca car il sont des argument commun dans train and test 
        #  cette classe base option va contenir pluiseur methode (helper) par exemple lire option or print option somthing like that 
        parser = BaseOptions.initialize(self, parser)
        # additionel option speceficament dans la phase options 
        ...
        # pour quoi ils ont seperer ca a parser parque il voulent pas user le modifier 
